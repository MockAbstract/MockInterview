...
namespace MockInterview.Infrastructure.Migrations
{
    ...
    [Migration("20221217194807_FirstMigration")]
            ...
            modelBuilder.Entity("MockInterview.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("42c6d39d-3a48-4d68-8b94-30f40b311a59"),
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTimeOffset(new DateTime(2022, 12, 18, 0, 48, 6, 546, DateTimeKind.Unspecified).AddTicks(7047), new TimeSpan(0, 5, 0, 0, 0)),
